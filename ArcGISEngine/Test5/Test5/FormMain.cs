...
namespace Test5
{
    public partial class FormMain : Form
    {
        ...
        private void btn_HawkEye_Click(object sender, EventArgs e)
        {
            ...
            {
                btn_HawkEye.Text = "↗";
                AeUtils.AddLayoutToHawkEye(axMapControl_HawkEye);
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                axTOCControl_Main.SetBuddyControl(axPageLayoutControl1);
        ...
        {
            tbx_Loc.Text = String.Format("{0} {1} {2}", e.pageX.ToString(".###"), e.pageY.ToString(".###"), axPageLayoutControl1.Page.Units.ToString().Substring(4));
        }
